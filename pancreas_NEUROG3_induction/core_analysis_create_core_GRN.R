...
# GRN file
maxcomb.path <- 'outputs/networks_targ0p05_SS50_bS5/Network0p05_10tfsPerGene/prior_atac_Miraldi_q_ChIP_bias10_maxComb'
maxcomb.par <- basename(maxcomb.path)
file_grn <- paste0(maxcomb.path,'/prior_atac_Miraldi_q_ChIP_bias10_maxComb_sp.tsv')
time.cond.list <- list(8,24,48,72) 
