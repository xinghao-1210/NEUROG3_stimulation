...
setwd('/Users/user/Desktop/big-data_analysis/NGS_XZ/NGS/mLASSO-StARS/modeling/infTRN_lassoStARS/pancreas_NEUROG3_induction/priorConstruction')
getwd()
#================== INPUTS ===================
...
file_peaks <- './inputs/ATAC_peaks.bed'
