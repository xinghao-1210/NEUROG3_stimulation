...
normGeneExprFile = 'pancreas_NEUROG3_induction/inputs/geneExpression/RNAseq_8_DESeq2_VSDcounts.txt';
targGeneFile = 'pancreas_NEUROG3_induction/inputs/targRegLists/targetGenes_names.txt';
potRegFile = 'pancreas_NEUROG3_induction/inputs/targRegLists/potRegs_names.txt';
tfaGeneFile = 'pancreas_NEUROG3_induction/inputs/targRegLists/genesForTFA.txt';
...
priorFile = ['pancreas_NEUROG3_induction/inputs/priors/' priorName '.tsv']; % Th17 ATAC-seq prior
edgeSS = 50;
minTargets = 3;
...
loInfo = {'pancreas_NEUROG3_induction/inputs/leaveOutLists/0-8hpi.txt','_0-8hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/0-24hpi.txt','_0-24hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/0-48hpi.txt','_0-48hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/0-72hpi.txt','_0-72hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/100-8hpi.txt','_100-8hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/100-24hpi.txt','_100-24hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/100-48hpi.txt','_100-48hpi';
    'pancreas_NEUROG3_induction/inputs/leaveOutLists/100-72hpi.txt','_100-72hpi';};
...
for lambdaBias = lambdaBiases
    ...
    instabilitiesDir = fullfile('pancreas_NEUROG3_induction/outputs',strrep(['instabilities_targ' ...
    ...
    % visualizations
    priorMergedTfsFile = ['pancreas_NEUROG3_induction/inputs/priors/' priorName '_mergedTfs.txt'];
