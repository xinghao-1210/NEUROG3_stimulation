...
do
	...
	declare -a inFileNames=("Core_prior_atac_Miraldi_q_ChIP_bias10_maxComb_fdr5_Pancreas_NEUROG3_${cond_time}hpiSet_All_ChIP.tsv" "Core_prior_atac_Miraldi_q_ChIP_bias10_maxComb_fdr5_Pancreas_NEUROG3_${cond_time}hpiSet_DE_ChIP.tsv")
