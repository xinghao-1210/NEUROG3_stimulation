...
networkInfs = {... 
    ...
    sprintf('HIOE_NEUROG3_induction/outputs/networks_targ0p05_SS50_bS5/Network0p05_6tfsPerGene/prior_atac_Miraldi_q_ChIP_bias10_maxComb/%dhpi_Cores/Core_prior_atac_Miraldi_q_ChIP_bias10_maxComb_fdr5_HIOE_NEUROG3_%dhpiSet_%s/GSEA/Core_prior_atac_Miraldi_q_ChIP_bias10_maxComb_fdr5_HIOE_NEUROG3_%dhpiSet_%s_GENESETplaceholder_Praw0p1_dir_wCut0p0_minSet5',cond_time,cond_time,cond_gene,cond_time,cond_gene); 
    '';         % .txt file list to limit TFs in heatmap, can be left as an empty string
    '_allTFs';  
    sprintf('HIOE_NEUROG3_induction/outputs/networks_targ0p05_SS50_bS5/Network0p05_6tfsPerGene/prior_atac_Miraldi_q_ChIP_bias10_maxComb/%dhpi_Cores/Core_prior_atac_Miraldi_q_ChIP_bias10_maxComb_fdr5_HIOE_NEUROG3_%dhpiSet_%s/GSEAenrich',cond_time,cond_time,cond_gene)};
    };
totNetworks = size(networkInfs,1);

%% END parameters

setInf = ['combSets_fdr' num2str(100*FDR_cutoff) '_top' num2str(topNtfSets) 'tfSets_' num2str(cond_time) 'hpi']; % for output
